...
public class Claim_RepoTestingSite
{
    ...
    public Claim_RepoTestingSite()
    {
        ...
        _claim = new Claim(ClaimType.Car, "Car Accident on 454", 400.00m, new System.DateTime(2018,04,27), new System.DateTime(2018,04,28));
        _claimRepo.AddClaimToTheDatabase(_claim);
    }
        [Fact]
        public void AddClaimToTheDatabase_ShouldReturnTrue()
        {
            var claim = new Claim(ClaimType.Home, "Break in, Damaged Property", 750.00m, new System.DateTime(2022,04,27), new System.DateTime(2022,04,30));
